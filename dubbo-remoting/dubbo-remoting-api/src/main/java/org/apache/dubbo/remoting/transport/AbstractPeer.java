...
/**
 * 1、实现ChannelHandler接口并且有在属性中还有一个handler，下面很多实现方法也是直接调用了handler方法，
 *    这种模式叫做装饰模式，这样做可以对装饰对象灵活的增强功能。
 * 2、在该类中有closing和closed属性，在Endpoint中有很多关于关闭通道的操作，会有关闭中和关闭完成的状态区分，
...
public abstract class AbstractPeer implements Endpoint, ChannelHandler {
    ...
    /**
     * 该方法比较简单，之前也讲过AbstractPeer类就做了装饰模式中装饰角色，
     * 只是维护了通道的正在关闭和关闭完成两个状态。然后到了MultiMessageHandler的received
     * @param ch
     * @param msg
     * @throws RemotingException
     */
